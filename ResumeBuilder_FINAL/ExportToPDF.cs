...
namespace ResumeBuilder_FINAL
{
    public static class ExportToPDF
    {
        public static void exportToPDF(List<Contact> contactInfo, List<Experience> experiences, List<Education> diplomas)
        {
            ...
            tf.DrawString(title, fontTitle, XBrushes.BlueViolet, rect, XStringFormats.Center);
            ...
            tf.Alignment = XParagraphAlignment.Center;
            tf.DrawString(contactText, fontRegular, XBrushes.Black, rect, XStringFormats.Center);
            ...
            tf.DrawString(subtitleExperience, fontCategories, XBrushes.BlueViolet, rect, XStringFormats.Center);
            ...
            tf.DrawString(subtitleEducation, fontCategories, XBrushes.BlueViolet, rect, XStringFormats.Center);
